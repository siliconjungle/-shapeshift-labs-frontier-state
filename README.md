...
- [`@shapeshift-labs/frontier-event-log`](https://www.npmjs.com/package/@shapeshift-labs/frontier-event-log): bounded event logs for replay windows and patch events; related to state but intentionally not a dependency.
